...
import 'package:dailyplan/frienddetails/friend_details_page.dart';
import 'package:dailyplan/friends/friend.dart';

class Clientes extends StatefulWidget {
  @override
  _ClientesState createState() => new _ClientesState();
}
...
class _ClientesState extends State<Clientes> {
  ...
  Widget build(BuildContext context) {
    ...
    return new Scaffold(
      appBar: new AppBar(title: new Text('Listado de Clientes')),
      body: content,
    );
  }
}
